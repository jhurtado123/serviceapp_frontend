  ...
  render() {
    ...
    return (
      <div className={'profile-image ' + (small ? 'small' : '')}
          style={{backgroundImage: `url(${otherImage ? otherImage : (user.profile_image ? `${process.env.REACT_APP_BACKEND_URI}/uploads/profile/${user._id}/${user.profile_image}` : DefaultProfileImage)})`,
